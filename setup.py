...
setup(
    ...
    description="Francisco Bispo's Utilities for Python",  # Optional
    ...
    classifiers=[  # Optional
        ...
        "Topic :: Software Development :: Code Utilities",
    ...
    keywords="python development utilities",  # Optional
    ...
    install_requires=[
        ...
        "google-api-core==2.19.2; python_version >= '3.7'",
        "google-api-python-client==2.143.0; python_version >= '3.7'",
        "google-auth==2.34.0; python_version >= '3.7'",
        "google-auth-httplib2==0.2.0",
        "google-auth-oauthlib==1.2.1; python_version >= '3.6'",
    ...
    project_urls={  # Optional
        ...
        "Funding": "",
        "Say Thanks!": "",
        "Source": "https://github.com/fcjbispo/fbpyutils/",
    },
)
